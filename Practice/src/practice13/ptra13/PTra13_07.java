...
public class PTra13_07 {
	...
	public static void main(String[] args) {
		...
		boolean superHeroDie = true;
		boolean slimeDie = true;

		superHeroDie = superHero.damage(slime.attack());
		if (superHeroDie) {
			System.out.println(slime.getName() + "は" + superHero.getName() + "との戦闘に勝利した。");
		}
		slimeDie = slime.damage(superHero.attack());
		if (slimeDie) {
